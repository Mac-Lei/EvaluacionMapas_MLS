package com.mac.evaluacionmapas_mals;
...
import com.mac.evaluacionmapas_mals.databinding.ActivityMapsBinding;
        ...
        locationTask.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    //Añadir un marcador en la ubicación actual y mover la cámara
                    ...
                    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(currentLatLng, 15)); //Zoom de la ubicación actual
                }
            }
        });
    }
